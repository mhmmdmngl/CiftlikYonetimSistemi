                    ...
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            $.ajax({
                                ...
                                type: "POST",
                                data: {
                                    "rfid": form.querySelector('[name="user_name"]').value, "hayvanAdi": form.querySelector('[name="user_email"]').value, "cinsiyet": form.querySelector('input[name="user_role"]:checked').value
                                },
